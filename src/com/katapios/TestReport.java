...
import com.katapios.data.DataSource;
import com.katapios.reporting.CustomerReport;

import java.io.IOException;
import java.util.Locale;

public class TestReport {
    //do not forget to add program arguments into project
    private static final String USAGE
            = "USAGE: java com.katapios.TestReport <dataFilePath>";
